...
import proyecto.*;
import proyecto.controlador.ControladorCliente;
import javax.swing.*;
...
public class FrmGestionClientes extends javax.swing.JFrame {
    ...
    private JTextField txtTelefono, txtCorreo, txtDireccion;
    ...
    public FrmGestionClientes() {
        arregloClientes = DatosSistema.getInstancia().getArregloClientes();
        initComponents();
    ...
    private JPanel crearPanelFormulario() {
        ...
        agregarCampo(panel, "Dirección:", txtDireccion = new JTextField());
    ...
    private JPanel crearPanelTabla() {
        ...
        String[] columnas = {"DNI", "Nombres", "Apellidos", "Teléfono", "Correo", "Dirección"};
        ...
        tablaClientes.getTableHeader().setBackground(new Color(0, 51, 102));
        tablaClientes.getTableHeader().setForeground(Color.WHITE);
        tablaClientes.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        tablaClientes.setSelectionBackground(new Color(230, 240, 255));
        tablaClientes.setGridColor(new Color(220, 220, 230));
        tablaClientes.getSelectionModel().addListSelectionListener(e -> {
            int fila = tablaClientes.getSelectedRow();
            if (fila >= 0) {
                String dni = (String) modeloTabla.getValueAt(fila, 0);
                Cliente c = arregloClientes.buscar(dni);
                if (c != null) {
                    cargarDatos(c);
                }
            }
    ...
    private void configurarControlador() {
        controlador = new ControladorCliente(this, arregloClientes);
    }
